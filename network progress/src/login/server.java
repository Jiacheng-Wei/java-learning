	...
	public static void main(String[] args) throws Exception{
		...
		try {
			...
			while(true)
			{
				...
				info.setCommandID(Byb.put(data,4,4).getInt(0));
				info.setTotalLength(((ByteBuffer) Byb.clear()).put(data, 0, 4).getInt(0));
				String username = new String(data,8,20,"UTF-8");
				String password = new String(data,28,30,"UTF-8");
